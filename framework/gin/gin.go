...
import (
	...
	"github.com/wxc/webfmk/framework/gin/internal/bytesconv"
	"github.com/wxc/webfmk/framework/gin/render"
)
...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://pkg.go.dev/github.com/wxc/webfmk/framework/gin#readme-don-t-trust-all-proxies for details.")
	}
